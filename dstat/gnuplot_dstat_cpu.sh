...
OUTPUT_FILE="data/plot/cpu.png"

plot() {
  gnuplot <<EOF
set terminal pngcairo size 1700,600 font "Roboto,16"

set title "CPU" font "{:Bold},24"
...
set ylabel "% Utilization" offset 1,0 font "{:Bold},14"
set xlabel "Time" offset 0,1 font "{:Bold},14"
